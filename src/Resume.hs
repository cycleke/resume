...
basicInfo =
  paragraph
    [ tex "name" "路遥柯" "cycleke",
      ...
      pure "\\homepage[cycleke.github.io]{https://cycleke.github.io/}",
      pure "}"
    ]
  where
...
algorithmDesign =
  paragraph
    [ itemTeX "算法设计" "Algorithm Design",
      cn "参加学习了算法竞赛，熟悉常用的数据结构和算法，具备一定的算法设计能力。",
...
devTools =
  paragraph
    [ itemTeX "开发工具" "Development Tool",
      cn "能适应常用编辑器和操作系统，日常在 Arch Linux 下使用 Emacs，",
      cn "具有使用 git 团队协作工具的经验。",
      en "can adapt to common editors/OSs, usually use Emacs under Arch Linux,",
...
miscellaneous =
  section "其他" "Miscellaneous" . pure $
    ritemize
      [ cen
          "英语：全国大学英语四级：554 分，全国大学英语六级：486 分。"
          "English: CET Band 4: 554 points, CET Band 6: 486 points.",
        cen "现担任程序设计创新基地主席，负责协调队伍间的训练，安排假期间的训练和授课。" $
          "As the chairman of programming innovation base,"
            ++ "I'm responsible for coordinating training between teams and arranging training and teaching during vacation."
      ]
